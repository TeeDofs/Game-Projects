...
public class Paddle : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if(collision.gameObject.CompareTag("Ball"))
        {
            ...
            Vector2 contactPoint = collision.GetContact(0).point; // get the first point of contact between paddle and ball
            ...
            collision.rigidbody.velocity = rotation * Vector2.up * ballSpeed;
        }
    }
}
